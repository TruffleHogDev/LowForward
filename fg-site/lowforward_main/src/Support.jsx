        ...
        <div className="max-w-screen-lg mx-auto">
          ...
          <div className="prose prose-invert max-w-none text-slate-300">
            ...
            <h3>
              ...
              was to find good, straightforward information on things like
              running basic offence, or to answer questions like "How do I
              poke?"
            </h3>

            <h3>
              I want to help smoothen the learning curve when it comes to
              understanding fighting games on a deeper level. Your support helps
              me make LowForward the best community resource it can possibly be.
            </h3>
