...
export default function Nothing() {
    return (
        ...
        <article className="articleStyles">
            ...
            playing like this can be against strong opponents. As an aside, Chains is a great Guilty Gear player as well and mad respect for letting me cherry pick a round that made me look 
            good. Shoutout to the FGCC!</p>
