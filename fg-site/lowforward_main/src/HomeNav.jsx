...
const HomeNav = () => {
    return (
        ...
        <img className='w-screen max-w-screen-md h-600 p-12 object-cover' 
            src={master}
            alt='/' />            
        <div className='grid sm:grid-cols-2 gap-12 object-contain'>
            <HomeItem img={meditation} title='Need to brush up on your fighting game terminology or need some character resources?' page="https://lowforward.com/#/resources" />
            <HomeItem img={Logo} title='Start your path to mastery with my comprehensive articles, designed to help you no matter your skill level.' page="https://lowforward.com/#/concepts" />
        </div>
    </div>
    )
}
