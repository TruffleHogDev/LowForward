    ...
    <>
      ...
      <div className="container">
        <article className="articleStyles">
          ...
          <p>
            On this page, we will cover every common defensive option in SF6 in
            terms of their properties, general use cases, and weaknesses. More
            detailed explanations of many of the systems in this article can be
            found on Supercombo's pages on Defense and Gauges- see the Resources
            page for a link to their wiki.
          </p>
          ...
          <dl>
            ...
            <figure>
              ...
              <figcaption>
                ...
                hitstop OS done during the first blockstring- the 5MP is timed
                to not come out during drive reversal, but will otherwise. As of
                S2, drive reversal is only -6 on block.
              </figcaption>
            </figure>
            ...
            <figure>
              ...
              ></video>
              <figcaption>
                Buffering level 3 behind DI-unsafe sequences can punish
                opponents who would otherwise correctly react to them.
              </figcaption>
            </figure>
          </dl>
